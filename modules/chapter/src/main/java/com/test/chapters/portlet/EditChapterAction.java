...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=editChapter"
        },
        service = MVCActionCommand.class
)
public class EditChapterAction extends BaseMVCActionCommand {
    @Override
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        System.out.println("Enter Edit Action");
        try {
            ...
            actionResponse.setRenderParameter("jspPage", "/edit-chapter.jsp");
        }catch (Exception e){
